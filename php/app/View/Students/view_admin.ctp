            ...
            <div>
                <div class="span7">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#config" data-toggle="tab">Configuration Status</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="config" class="tab-pane">
                            <?php echo $this->Html->link(__('Edit Configurations'), array('action' => 'individual_configuration', $student['Student']['id']),array('class' => 'btn btn-primary')); ?>
                            <table class="table table-striped">

                                <tbody>
                                <tr>
                                    <td>Freeze/Unfreeze Status:</td>
                                    <td style="font-weight: bold">
                                        <?php
                                        if($student['Student']['freeze_state']==0){
                                            echo "Unfreeze";
                                        }
                                        if($student['Student']['freeze_state']==1){
                                            echo "Freeze";
                                        }
                                        ?>
                                    </td>
                                ...
                                <tr>
                                    <td>Public Ready Status:</td>
                                    <td style="font-weight: bold">
                                        <?php
                                        if($student['Student']['industry_ready']==0){
                                            echo "Not Public Ready";
                                        }
                                        if($student['Student']['industry_ready']==1){
                                            echo "Public Ready";
                                        }
                                        ?>
                                    </td>
                                ...
                                <tr>
                                    <td>Approval Progress Status:</td>
                                    <td style="font-weight: bold">
                                        <?php
                                        echo Convention::approval_stat($student['Student']['approved_state']);
                                        ?>
                                    </td>
                                </tr>
