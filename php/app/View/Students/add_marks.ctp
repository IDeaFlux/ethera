...
<?php $this->set('title', 'Add Marks to Students'); ?>
...
<div class="row">
    ...
    <div class="span9">
        ...
        $this->Js->get('#load_marking')->event('click',
            $this->Js->request(array(
                    'controller'=>'students',
                    'action'=>'get_marking'
                ), array(
        ...
        <button class="btn btn-mini" id="load_marking">Load Available Enrollments</button>
        <div id='tabs'></div>
        <div class="form-actions">
            <?php echo $this->Form->submit('Save Markings', array(
                'div' => false,
