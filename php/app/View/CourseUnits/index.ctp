<div class="courseUnits index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $courseUnit['CourseUnit']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $courseUnit['CourseUnit']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $courseUnit['CourseUnit']['id']), null, __('Are you sure you want to delete # %s?', $courseUnit['CourseUnit']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
